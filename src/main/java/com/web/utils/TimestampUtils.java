...
public class TimestampUtils {
    ...
    public Date getStartOfDayAsDate(Timestamp timestamp) {
        LocalDateTime ldt = timestamp.toLocalDateTime();
        LocalDateTime startOfDay = ldt.toLocalDate().atStartOfDay();
        return Date.valueOf(startOfDay.toLocalDate());
    }
    ...
    public Date getEndOfDayAsDate() {
        LocalDate date = toLocalDateTime().toLocalDate();
        LocalDateTime endOfDay = date.atTime(23, 59, 59, 999_000_000);
        return Date.valueOf(endOfDay.toLocalDate());
    }

    public Date getEndOfDayAsDate(Timestamp timestamp) {
        LocalDateTime ldt = timestamp.toLocalDateTime();
        LocalDate date = ldt.toLocalDate();
        LocalDateTime endOfDay = date.atTime(23, 59, 59, 999_000_000);
        return Date.valueOf(endOfDay.toLocalDate());
