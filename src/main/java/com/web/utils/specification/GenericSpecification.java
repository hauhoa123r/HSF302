...
import com.web.utils.NumberTypeUtils;
...
public class GenericSpecification<T> implements Specification<T> {
    ...
    private Predicate getPredicate(@NonNull Root<T> root, CriteriaQuery<?> criteriaQuery,
        ...
        switch (searchCriteria.getComparisonOperator()) {
            ...
            case GREATER_THAN -> {
                return criteriaBuilder.greaterThan(PathUtils.getPath(realPath, javaType),
                        (Comparable) searchCriteria.getComparedValue());
            }
            case LESS_THAN -> {
                return criteriaBuilder.lessThan(PathUtils.getPath(realPath, javaType),
                        (Comparable) searchCriteria.getComparedValue());
            }
            case GREATER_THAN_OR_EQUAL_TO -> {
                return criteriaBuilder.greaterThanOrEqualTo(PathUtils.getPath(realPath, javaType),
                        (Comparable) searchCriteria.getComparedValue());
            }
            case LESS_THAN_OR_EQUAL_TO -> {
                return criteriaBuilder.lessThanOrEqualTo(PathUtils.getPath(realPath, javaType),
                        (Comparable) searchCriteria.getComparedValue());
            }
            case LIKE -> {
                return criteriaBuilder.like(PathUtils.getPath(realPath, javaType),
                        searchCriteria.getComparedValue().toString());
            }
            case NOT_LIKE -> {
                return criteriaBuilder.notLike(PathUtils.getPath(realPath, javaType),
                        searchCriteria.getComparedValue().toString());
            }
            case CONTAINS -> {
                return criteriaBuilder.like(PathUtils.getPath(realPath, javaType),
            ...
            case AVG_EQUALS -> {
                ...
                criteriaQuery.having(
                        criteriaBuilder.equal(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
            ...
            case AVG_NOT_EQUALS -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.notEqual(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case AVG_GREATER_THAN -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.greaterThan(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case AVG_LESS_THAN -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.lessThan(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case AVG_GREATER_THAN_OR_EQUAL_TO -> {
                ...
                criteriaQuery.having(criteriaBuilder
                        .greaterThanOrEqualTo(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case AVG_LESS_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .lessThanOrEqualTo(criteriaBuilder.avg(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            ...
            case SUM_EQUALS -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.equal(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case SUM_NOT_EQUALS -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.notEqual(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case SUM_GREATER_THAN -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.greaterThan(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case SUM_LESS_THAN -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.lessThan(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case SUM_GREATER_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .greaterThanOrEqualTo(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case SUM_LESS_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .lessThanOrEqualTo(criteriaBuilder.sum(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            ...
            case MAX_EQUALS -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.equal(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MAX_NOT_EQUALS -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.notEqual(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MAX_GREATER_THAN -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.greaterThan(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MAX_LESS_THAN -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.lessThan(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MAX_GREATER_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .greaterThanOrEqualTo(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MAX_LESS_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .lessThanOrEqualTo(criteriaBuilder.max(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            ...
            case MIN_EQUALS -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.equal(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MIN_NOT_EQUALS -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.notEqual(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MIN_GREATER_THAN -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.greaterThan(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MIN_LESS_THAN -> {
                criteriaQuery.groupBy(root);
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(
                        criteriaBuilder.lessThan(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MIN_GREATER_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .greaterThanOrEqualTo(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
            case MIN_LESS_THAN_OR_EQUAL_TO -> {
                ...
                Double value = NumberTypeUtils.convertNumberValue(searchCriteria.getComparedValue(), Double.class);
                criteriaQuery.having(criteriaBuilder
                        .lessThanOrEqualTo(criteriaBuilder.min(PathUtils.getPath(realPath, javaType)), value));
                return criteriaBuilder.conjunction();
            }
