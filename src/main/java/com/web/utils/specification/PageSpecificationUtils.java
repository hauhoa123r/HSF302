...
public class PageSpecificationUtils<T> {
    ...
    public Page<T> getPage(Specification<T> dataSpecification, Specification<T> countSpecification, Pageable pageable,
            Class<T> entityClass, boolean isCountDistinct) {
