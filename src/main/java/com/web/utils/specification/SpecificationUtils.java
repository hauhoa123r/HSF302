...
public class SpecificationUtils<T> {
    ...
    @Autowired
    public void setGenericSpecificationObjectProvider(
            ObjectProvider<GenericSpecification<T>> genericSpecificationObjectProvider) {
    ...
    public Specification<T> getSearchSpecification(SearchCriteria searchCriteria) {
        if (searchCriteria == null || searchCriteria.getFieldName() == null
                || searchCriteria.getComparisonOperator() == null || searchCriteria.getComparedValue() == null) {
            return null;
        }
        GenericSpecification<T> genericSpecification = genericSpecificationObjectProvider.getObject();
        genericSpecification.setSearchCriteriaLogicalOperatorMap(this.searchCriteriaLogicalOperatorMap);
    ...
    public Specification<T> getSearchSpecification(String fieldName, ComparisonOperator comparisonOperator,
            Object comparedValue, JoinType joinType) {
    ...
    public Specification<T> getSortSpecification(String fieldName, AggregationFunction aggregationFunction,
            SortDirection sortDirection, JoinType joinType) {
